...
TTS error handling for requests processed in this chapter is defined in {{tts-error-responses}}.
...
## Authorization Server Error Responses {#actor-profile-error-responses}
